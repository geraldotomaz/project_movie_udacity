...
stranger_things = TvShow.TvShow("Stranger Things",
                                ...
                                "4",
                                "10",
                                "http://pipocacombo.com/wp-content/uploads/2009/11/avatar-poster-fake.jpg")
                              

game_of_thornes = TvShow.TvShow("Game Of Thrones",
                                "130min",
                                "Tv Show",
                                "https://www.youtube.com/watch?v=4Cmk9ACwc7w",
                                "https://pmcdeadline2.files.wordpress.com/2016/02/got-poster-2.jpg",
                                "7",
                                "7",                                
...
suits = TvShow.TvShow("Suits",
                      ...
                      "2",
                      "5",
                      "Mike Ross (Patrick J. Adams) is a genius college dropout, who, with his natural intelligence and eidetic memory")



narcos = TvShow.TvShow("Narcos",
                       "160min",
                       "Tv Show",
                       "https://www.youtube.com/watch?v=U7elNhHwgBU",
                       "https://static.omelete.uol.com.br/media/extras/conteudos/Escobar.jpg",
                       "4",
                       "10",
...
avatar = media.Movie("Avatar",
                     ...
                     "http://pipocacombo.com/wp-content/uploads/2009/11/avatar-poster-fake.jpg",
                     "Epic science fiction film directed, written, produced, and co-edited by James Cameron.")

apocalypto = media.Movie("Apocalypto",
                         "130min",
                         "Movie",
                         "https://www.youtube.com/watch?v=ngWBddVNVZs",
                         "http://www.impawards.com/2006/posters/apocalypto.jpg",
                         "Epic science fiction film directed, written, produced, and co-edited by James Cameron.")
...
movies = [stranger_things, game_of_thornes, suits, narcos, avatar, apocalypto, django, fight_club]
